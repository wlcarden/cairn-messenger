...
- the initial design conversation (in git history) — adversarial review finding #7 surfaced the inconsistency; the initial design conversation captured it as an open question
